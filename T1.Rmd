...
#indexClass <- 5
 ...
 nTrees <- 10
 randomTrees10 <- list()b
 randomTrees10 <- ensemble(data2, indexClass, nTrees)
 accuracy[1] <- computeAcc(randomTrees10, test, indexClass)
 
 nTrees <- 25
 randomTrees25 <- vector()
 randomTrees25 <- ensemble(data2, indexClass, nTrees)
 accuracy[2] <- computeAcc(randomTrees25, test, indexClass)
  
 nTrees <- 50
 randomTrees50 <- vector()
 randomTrees50 <- ensemble(data2, indexClass, nTrees)
 accuracy[3] <- computeAcc(randomTrees50, test, indexClass)
```