...
for(i in 1:10){
  ...
  #print(computeAcc(randomTrees, test, indexClass))
  accuracy10 <- c(accuracy10, computeAcc(randomTrees, test, indexClass))
  
  nTrees <- 25
  randomTrees <- ensemble(train, indexClass, nTrees)
  accuracy25 <- c(accuracy25, computeAcc(randomTrees, test, indexClass))

  nTrees <- 50
  randomTrees <- ensemble(train, indexClass, nTrees)
  accuracy50 <- c(accuracy50, computeAcc(randomTrees, test, indexClass))

  nTrees <- 100
  randomTrees <- ensemble(train, indexClass, nTrees)
  accuracy100 <- c(accuracy100, computeAcc(randomTrees, test, indexClass))
}
```
